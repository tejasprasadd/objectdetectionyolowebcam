...
model = YOLO("pythonProject/Yolo-Weights/yolov8x.pt")  # Load the YOLO model (using pretrained weights)

# Class names for the COCO dataset (this list holds the names of the 80 objects the model can detect)
class_names = [
